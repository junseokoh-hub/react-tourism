    ...
    <nav className="p-2 w-80 h-full bg-teal-100 z-[100] fixed top-0 right-0">
      <ul className="h-full space-y-10 relative">
        ...
        <li className="flex flex-col divide-y-2 divide-blue-400">
          <span className="h-20 flex items-center border-t-2 border-blue-400">
            My Store
          </span>
          <span className="h-20 flex items-center ">My Review</span>
          <span className="h-20 flex items-center ">My Journey</span>
        </li>
        <li className="pt-4 flex justify-around border-t-8">
